locals {
  ...
  opencost_ui_image     = "${local.ar_hostname}/${var.project_id}/${google_artifact_registry_repository.opencost.repository_id}/opencost-ui"
  opencost_ui_image_ref = "${local.opencost_ui_image}:${var.image_tag}"
